...
This add-on integrates Solr into your [DDEV](https://ddev.com/) project and creates Solr cores according to the configuration defined in [`.ddev/typo3-solr/config.yaml`](https://github.com/ddev/ddev-typo3-solr/blob/main/typo3-solr/config.yaml).
