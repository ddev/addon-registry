...
* This add-on installs a [`.ddev/docker-compose.solr.yaml`](https://github.com/ddev/ddev-drupal-solr/blob/main/docker-compose.solr.yaml) using the `solr:8` docker image.
