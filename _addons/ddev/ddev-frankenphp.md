---
title: ddev/ddev-frankenphp
github_url: https://github.com/ddev/ddev-frankenphp
description: "FrankenPHP server (generic webserver) for PHP built on top of Caddy for DDEV"
user: ddev
...
For extensions not available as pre-packaged, use [PHP/PIE](https://packagist.org/extensions), create a file [`.ddev/web-build/Dockerfile.frankenphp_extra`](https://github.com/ddev/ddev-frankenphp/blob/main/./tests/testdata/.ddev/web-build/Dockerfile.frankenphp_extra) with the following content:
...
To change the default `Caddyfile` configuration, remove the `#ddev-generated` line from [`.ddev/web-build/Caddyfile.frankenphp`](https://github.com/ddev/ddev-frankenphp/blob/main/./web-build/Caddyfile.frankenphp) and edit it.

Alternatively, create a file [`.ddev/docker-compose.frankenphp_extra.yaml`](https://github.com/ddev/ddev-frankenphp/blob/main/./tests/testdata/.ddev/docker-compose.frankenphp_extra.yaml) with the following content:
