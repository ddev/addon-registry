...
For extensions not available as pre-packaged use [PHP/PIE](https://github.com/php/pie), create a file [`.ddev/web-build/Dockerfile.frankenphp_extra`](https://github.com/ddev/ddev-frankenphp/blob/main/./tests/testdata/.ddev/web-build/Dockerfile.frankenphp_extra) with the following content:
...
To modify the default [Caddyfile](https://github.com/ddev/ddev-frankenphp/blob/main/./web-build/Caddyfile.frankenphp) configuration, either remove `#ddev-generated` line and edit it directly, or create a file [`.ddev/docker-compose.frankenphp_extra.yaml`](https://github.com/ddev/ddev-frankenphp/blob/main/./tests/testdata/.ddev/docker-compose.frankenphp_extra.yaml) with the following content:
