...
The BackstopJS Docker image is extended with additional functionality using a custom Docker build. See [Dockerfile](https://github.com/ddev/ddev-backstopjs/blob/main/backstopBuild/Dockerfile) and the custom [entrypoint](https://github.com/ddev/ddev-backstopjs/blob/main/backstopBuild/entrypoint.sh).
...
To change this, edit the file [docker-compose.backstop.yaml](https://github.com/ddev/ddev-backstopjs/blob/main/docker-compose.backstop.yaml) and update the path in the `volumes` section. Move your files to the new directory and restart DDEV.
