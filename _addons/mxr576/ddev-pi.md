...
This add-on provides several ways to customize the container environment and manage Pi extensions. For detailed information, please see the [Extensibility document](https://github.com/mxr576/ddev-pi/blob/main/docs/extensions.md).
