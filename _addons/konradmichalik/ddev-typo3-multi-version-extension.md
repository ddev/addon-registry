...
- [**Parallel TYPO3 instances**](https://github.com/konradmichalik/ddev-typo3-multi-version-extension/blob/main/docs/commands.md): TYPO3 12, 13 and 14 run side by side by default under `.Build/<version>/`; TYPO3 11 can be re-enabled (see [Configuration](https://github.com/konradmichalik/ddev-typo3-multi-version-extension/blob/main/docs/configuration.md))
...
Full flags, exit behaviour and examples for every command are in [docs/installation.md](https://github.com/konradmichalik/ddev-typo3-multi-version-extension/blob/main/docs/installation.md) and [docs/commands.md](https://github.com/konradmichalik/ddev-typo3-multi-version-extension/blob/main/docs/commands.md).
...
| Topic | What's inside |
|-------|---------------|
| [Installing instances](https://github.com/konradmichalik/ddev-typo3-multi-version-extension/blob/main/docs/installation.md) | Every `ddev install` flag: versions, `--classic`, `--demo[=profile]`, `-v/--verbose` |
| [Commands](https://github.com/konradmichalik/ddev-typo3-multi-version-extension/blob/main/docs/commands.md) | `ddev launch`, running commands per version or across all instances, worktree commands |
| [Configuration](https://github.com/konradmichalik/ddev-typo3-multi-version-extension/blob/main/docs/configuration.md) | `project.sh` variables, install hooks, fixtures, symlink exclusions, application context, CS-fixer exclusion |
| [Classic mode](https://github.com/konradmichalik/ddev-typo3-multi-version-extension/blob/main/docs/classic-mode.md) | Rebuilding a version as a non-Composer, TER-style install |
| [Git worktrees](https://github.com/konradmichalik/ddev-typo3-multi-version-extension/blob/main/docs/git-worktrees.md) | Running several checkouts of the same repository side by side |

## 🧑‍💻 Contributing

Please have a look at [`CONTRIBUTING.md`](https://github.com/konradmichalik/ddev-typo3-multi-version-extension/blob/main/CONTRIBUTING.md).
...
This project is licensed under [Apache-2.0](https://github.com/konradmichalik/ddev-typo3-multi-version-extension/blob/main/LICENSE).
