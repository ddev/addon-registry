---
title: mandclu/ddev-drupal-contrib-lite
github_url: https://github.com/mandclu/ddev-drupal-contrib-lite
...
![Folder tree](https://raw.githubusercontent.com/mandclu/ddev-drupal-contrib-lite/main/assets/folders.png)
...
Override any environment variable value from [.ddev/config.contrib.yaml](https://github.com/mandclu/ddev-drupal-contrib-lite/blob/main/config.contrib.yaml) by creating a `.ddev/config.local.yaml` (or [any filename lexicographically following config.contrib.yaml](https://ddev.readthedocs.io/en/stable/users/extend/customization-extendibility/#extending-configyaml-with-custom-configyaml-files)) file which has the same structure as [.ddev/config.contrib.yaml](https://github.com/mandclu/ddev-drupal-contrib-lite/blob/main/config.contrib.yaml). Add your overrides under `web_environment`.
