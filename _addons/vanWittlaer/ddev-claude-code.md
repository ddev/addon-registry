---
title: vanWittlaer/ddev-claude-code
github_url: https://github.com/vanWittlaer/ddev-claude-code
description: "Allow using Claude Code from inside ddev web container, facilitate git authentication and commit signing"
user: vanWittlaer
