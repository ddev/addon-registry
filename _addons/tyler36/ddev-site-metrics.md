---
title: tyler36/ddev-site-metrics
github_url: https://github.com/tyler36/ddev-site-metrics
description: "Intergrate Grafana and OpenTelemetry into your project"
user: tyler36
...
In this add-on, Grafana Alloy forwards open telemetry data it receives to Grafana Tempo for processing ([./alloy/otelcol.alloy](https://github.com/tyler36/ddev-site-metrics/blob/main/./alloy/otelcol.alloy)). Grafana Tempo datasource is pre-configured in Grafana allowing a centralized location for interacting with traces.
